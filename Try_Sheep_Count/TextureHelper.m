...
+(void) initTextures{
    ...
    time02  = [SKTexture textureWithImageNamed:@"score2"];
    time03  = [SKTexture textureWithImageNamed:@"score3"];
    time04  = [SKTexture textureWithImageNamed:@"score4"];
    time05  = [SKTexture textureWithImageNamed:@"score5"];
    time06  = [SKTexture textureWithImageNamed:@"score6"];
    time07  = [SKTexture textureWithImageNamed:@"score7"];
    time08  = [SKTexture textureWithImageNamed:@"score8"];
    time09  = [SKTexture textureWithImageNamed:@"score9"];
    time00  = [SKTexture textureWithImageNamed:@"score0"];
    ...
    UIImage * image01 = [UIImage imageNamed:@"score1"];
    UIImage * image02 = [UIImage imageNamed:@"score2"];
    UIImage * image03 = [UIImage imageNamed:@"score3"];
    UIImage * image04 = [UIImage imageNamed:@"score4"];
    UIImage * image05 = [UIImage imageNamed:@"score5"];
    UIImage * image06 = [UIImage imageNamed:@"score6"];
    UIImage * image07 = [UIImage imageNamed:@"score7"];
